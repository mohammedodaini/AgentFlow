...
- **Phase:** **M1–M14 complete (2026-08-20).** Backend `make check` green — ruff,
  ruff format, mypy strict over **240 files**, **830 tests**, **97.31% coverage**
  (gate at 97%). Frontend `make web-check` green over 10 routes, and `make smoke`
  drives a real browser through the whole product: **21/21**. See
  [docs/milestones/M14-more-integrations.md](docs/milestones/M14-more-integrations.md).
