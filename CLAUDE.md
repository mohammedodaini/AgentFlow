...
- **Phase:** **M1–M15 complete (2026-08-21).** Backend `make check` green — ruff,
  ruff format, mypy strict over **246 files**, **885 tests**, **97.13% coverage**
  (gate at 97%). Frontend `make web-check` green over 10 routes, and `make smoke`
  drives a real browser through the whole product: **23/23**. See
  [docs/milestones/M15-multi-agent.md](docs/milestones/M15-multi-agent.md).
