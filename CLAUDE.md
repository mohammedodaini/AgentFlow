...
- **Phase:** **M1–M13 complete (2026-08-20).** Backend `make check` green — ruff,
  ruff format, mypy strict over **232 files**, **713 tests**, **97.14% coverage**
  (gate at 97%). Frontend `make web-check` green, and `make smoke` drives a real
  browser through the whole product: 13/13. See
  [docs/milestones/M13-frontend.md](docs/milestones/M13-frontend.md).
