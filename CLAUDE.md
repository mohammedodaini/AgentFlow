...
- **Phase:** **M1–M8 complete (2026-08-13).** `make check` green — ruff, ruff
  format, mypy strict over **209 files**, **456 tests**, **98.35% coverage**
  (gate at 97%). Pyramid: unit 264 / integration 88 / e2e 106.
  See [docs/milestones/M8-evaluation.md](docs/milestones/M8-evaluation.md).
...
- **Mode: autonomous through M12.** The user said, verbatim: *"let us do that
  ...
  otherwise.
- **Next: M9 (first agent — LangGraph, tools, `agent_runs`/`agent_steps`).**
  Build it autonomously; do not ask first. Refuse to build multi-agent (M15)
  before the single agent measurably works.
